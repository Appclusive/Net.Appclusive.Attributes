...
{
    public class Approval7 : BaseModel
    {
        [AttributeName(PublicConstants.Approval.Approval7.RoleId)]
        [Range(0, long.MaxValue)]
        public virtual long RoleId { get; set; }

        [AttributeName(PublicConstants.Approval.Approval7.UserId)]
        [Range(0, long.MaxValue)]
        public virtual long UserId { get; set; }

        [AttributeName(PublicConstants.Approval.Approval7.Type)]
        [Range((long) ApprovalType.Default, (long) ApprovalType.AutoDecline)]
        public virtual long Type { get; set; }

        [AttributeName(PublicConstants.Approval.Approval7.AbsoluteExpiration)]
        public virtual long AbsoluteExpiration { get; set; }

        [AttributeName(PublicConstants.Approval.Approval7.RelativeExpiration)]
