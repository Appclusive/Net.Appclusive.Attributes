...
{
    public class Approval1 : BaseModel
    {
        [AttributeName(PublicConstants.Approval.Approval1.RoleId)]
        [Range(0, long.MaxValue)]
        public virtual long RoleId { get; set; }

        [AttributeName(PublicConstants.Approval.Approval1.UserId)]
        [Range(0, long.MaxValue)]
        public virtual long UserId { get; set; }

        [AttributeName(PublicConstants.Approval.Approval1.Type)]
        [Range((long) ApprovalType.Default, (long) ApprovalType.AutoDecline)]
        public virtual long Type { get; set; }

        [AttributeName(PublicConstants.Approval.Approval1.AbsoluteExpiration)]
        public virtual long AbsoluteExpiration { get; set; }

        [AttributeName(PublicConstants.Approval.Approval1.RelativeExpiration)]
