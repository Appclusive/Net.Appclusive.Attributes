...
{
    public class Approval4 : BaseModel
    {
        [AttributeName(PublicConstants.Approval.Approval4.RoleId)]
        [Range(0, long.MaxValue)]
        public virtual long RoleId { get; set; }

        [AttributeName(PublicConstants.Approval.Approval4.UserId)]
        [Range(0, long.MaxValue)]
        public virtual long UserId { get; set; }

        [AttributeName(PublicConstants.Approval.Approval4.Type)]
        [Range((long) ApprovalType.Default, (long) ApprovalType.AutoDecline)]
        public virtual long Type { get; set; }

        [AttributeName(PublicConstants.Approval.Approval4.AbsoluteExpiration)]
        public virtual long AbsoluteExpiration { get; set; }

        [AttributeName(PublicConstants.Approval.Approval4.RelativeExpiration)]
