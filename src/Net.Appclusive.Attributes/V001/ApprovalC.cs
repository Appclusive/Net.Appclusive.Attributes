...
{
    public class ApprovalC : BaseModel
    {
        [AttributeName(PublicConstants.Approval.ApprovalC.RoleId)]
        [Range(0, long.MaxValue)]
        public virtual long RoleId { get; set; }

        [AttributeName(PublicConstants.Approval.ApprovalC.UserId)]
        [Range(0, long.MaxValue)]
        public virtual long UserId { get; set; }

        [AttributeName(PublicConstants.Approval.ApprovalC.Type)]
        [Range((long) ApprovalType.Default, (long) ApprovalType.AutoDecline)]
        public virtual long Type { get; set; }

        [AttributeName(PublicConstants.Approval.ApprovalC.AbsoluteExpiration)]
        public virtual long AbsoluteExpiration { get; set; }

        [AttributeName(PublicConstants.Approval.ApprovalC.RelativeExpiration)]
